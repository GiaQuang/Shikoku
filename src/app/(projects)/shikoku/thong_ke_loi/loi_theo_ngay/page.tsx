...
const MachineChart = () => {
  ...
  // Hàm tạo dữ liệu ngẫu nhiên cho biểu đồ (theo số ngày trong tháng)
  const generateRandomData = (daysInMonth: number) => {
  ...
  // Tạo dữ liệu mẫu - Biểu đồ 4 cột theo ngày
  const generateChartData = () => {
    ...
    const allData = errorCategories.map((category) => {
      const dailyData = generateRandomData(daysInMonth);
      ...
      return {
        ...
        barMaxWidth: 11, // Thu nhỏ chiều rộng của bar vì có nhiều ngày
        barGap: "5%",
  ...
  const updateChart = () => {
    ...
    const option = {
      ...
      title: {
        text: `Thống Kê Lỗi Sản Xuất Tháng ${month}/${year}`,
        ...
        formatter: function (params: any) {
          ...
          return `
            <div style="padding: 10px; background-color: rgba(50, 50, 50, 0.9); border-radius: 8px; border: 1px solid #555; color: #fff;">
              <div style="font-weight:bold;margin-bottom:10px;font-size:16px;">Ngày ${params[0].axisValue}/${month}/${year}</div>
      ...
      xAxis: [
        {
          ...
          axisLabel: {
            ...
            //   // Hiển thị mỗi 2 ngày nếu có nhiều hơn 15 ngày
            //   return daysInMonth > 15 ? index % 2 === 0 : true;
            // },
            interval: 0,
            rotate: 0,
          },
  ...
  }, [chart, displayMonth, displayYear]); // Cập nhật khi chart, displayMonth hoặc displayYear thay đổi
  ...
  const handleSearch = () => {
    ...
    toast.success("Đang tìm kiếm dữ liệu...");
  };
  ...
  const exportReport = () => {
    ...
    alert(
      `Đang xuất báo cáo thống kê lỗi tháng ${displayMonth}/${displayYear}`
    );
    ...
    link.download = `Thong_ke_loi_thang_${displayMonth}_${displayYear}.png`;
    link.href = url;
    link.click();
  };
  ...
  return (
    <div className="min-h-screen bg-gray-900 text-white p-6">
      <div className="max-w-8xl mx-auto">
        ...
        >
          <div className="text-2xl font-bold">Phân Tích Lỗi Theo Tháng</div>
          ...
          <div className="flex flex-wrap items-center gap-4">
            ...
            >
              ...
              <select
                ...
                className="bg-gray-800 text-white border rounded p-2 outline-none"
